...
public class ColorController : MonoBehaviour
{
    ...
    public void Reset()
    {
        ...
        //if (stepsMaterial)
        //stepsMaterial.SetColor("_Color", colors[0].blockColor);
    ...
    public void nextColor()
    {
        //Background
        bgIndexFrom++;
        bgIndexFrom = bgIndexFrom >= colors.Count ? 0 : bgIndexFrom;
        bgIndexTo = bgIndexFrom == colors.Count - 1 ? 0 : bgIndexFrom + 1;
